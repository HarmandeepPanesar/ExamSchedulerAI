...
//    {
//        public DeepsensorClientContext()
//        {
//        }
...
//                //                optionsBuilder.UseSqlServer("Server=mmu-activateazure.database.windows.net;Database=Deepsensor.Client;User Id=mmusqllogin;Password=Test4218#;MultipleActiveResultSets=true");
...
//                entity.HasOne(d => d.Exam)
//                    .WithMany(p => p.PExamStudentProctoringStatus)
//                    .HasForeignKey(d => d.ExamId)
//                    .OnDelete(DeleteBehavior.ClientSetNull)
//                    .HasConstraintName("FK_pExamStudentProctoringStatus_pExam");

//                entity.HasOne(d => d.Student)
//                    .WithMany(p => p.PExamStudentProctoringStatus)
//                    .HasForeignKey(d => d.StudentId)
//                    .OnDelete(DeleteBehavior.ClientSetNull)
//                    .HasConstraintName("FK_pExamStudentProctoringStatus_pStudent");
//            });
...
//                entity.HasOne(d => d.ProctoringStatu)
//                    .WithMany(p => p.PProctroingEvaluation)
//                    .HasForeignKey(d => d.ProctoringStatuId)
//                    .OnDelete(DeleteBehavior.ClientSetNull)
//                    .HasConstraintName("FK_pProctroingEvaluation_pProctroingEvaluation");
//            });
