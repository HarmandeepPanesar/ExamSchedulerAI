...
{
    public partial class DeepsensorClientContext : DbContext
    {
        public DeepsensorClientContext(DbContextOptions<DeepsensorClientContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<LiveProctorMessage> LiveProctorMessage { get; set; }
        ...
        public virtual DbSet<StudentImpersonation> PStudentImpersonation { get; set; }
        public virtual DbSet<pExamStudentProctoringStatusLogs> pExamStudentProctoringStatusLogs { get; set; }
        public virtual DbSet<pLogs> pLogs { get; set; }
        public virtual DbSet<ExamUploads> ExamUploads { get; set; }
        public virtual DbSet<DashboardItems> DashboardItems { get; set; }
        public virtual DbSet<BlackList> BlackList { get; set; }
        public object StudentService { get; internal set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PStudentFaculty>(entity =>
            {
                ...
                //entity.HasOne(d => d.ExamStudent)
                //    .WithMany(p => p.PStudentFaculty)
                //    .HasForeignKey(d => d.ExamStudentId)
                //    .OnDelete(DeleteBehavior.ClientSetNull)
                //    .HasConstraintName("FK_pStudentFaculty_pExamStudent");
            });
            ...
            modelBuilder.Entity<pExamStudentProctoringStatusLogs>(entity =>
            {
                entity.Property(e => e.CreatedBy)
                    .IsRequired()
                    .HasMaxLength(50)
